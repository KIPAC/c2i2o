...
@pytest.fixture
def trained_emulator(baseline_cosmology, tmp_path):
...
class TestC2IEmulatorImplInitialization:
    ...
    def test_load_emulator_basic(self, trained_emulator):
    ...
    def test_load_emulator_with_output_dir(self, trained_emulator, tmp_path):
    ...
    def test_load_emulator_nonexistent_raises_error(self, tmp_path):
...
class TestC2IEmulatorImplEmulate:
    ...
    def test_emulate_basic(self, trained_emulator):
    ...
    def test_emulate_single_sample(self, trained_emulator):
    ...
    def test_emulate_with_batch_size(self, trained_emulator):
    ...
    def test_emulate_wrong_parameters_raises_error(self, trained_emulator):
    ...
    def test_emulate_returns_tf_tensors(self, trained_emulator):
...
class TestC2IEmulatorImplEmulateFromFile:
    ...
    def test_emulate_from_file_no_save(self, trained_emulator, tmp_path):
    ...
    def test_emulate_from_file_with_save(self, trained_emulator, tmp_path):
    ...
    def test_emulate_from_file_missing_input_raises_error(self, trained_emulator, tmp_path):
    ...
    def test_emulate_from_file_creates_output_dir(self, trained_emulator, tmp_path):
...
class TestC2IEmulatorImplSavePredictions:
    ...
    def test_save_predictions(self, trained_emulator, tmp_path):
    ...
    def test_save_predictions_creates_parent_dir(self, trained_emulator, tmp_path):
...
class TestC2IEmulatorImplYAML:
    ...
    def test_to_yaml(self, trained_emulator, tmp_path):
    ...
    def test_to_yaml_creates_parent_dir(self, trained_emulator, tmp_path):
    ...
    def test_from_yaml(self, trained_emulator, tmp_path):
        ...
        assert loaded_impl.output_dir == tmp_path / "results"

    def test_from_yaml_missing_file_raises_error(self, tmp_path, trained_emulator):
...
class TestC2IEmulatorImplGetInfo:
    ...
    def test_get_emulator_info(self, trained_emulator):
...
class TestC2IEmulatorImplRepr:
    ...
    def test_repr_trained(self, trained_emulator):
