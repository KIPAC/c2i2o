...
"""Unit tests for NumpyTensorSet class."""
...
class TestNumpyTensorSetInitialization:
    ...
    def test_init_2d_product_grid(self):
    ...
    def test_init_wrong_shape_raises_error(self):
    ...
    def test_init_wrong_n_samples_raises_error(self):
    ...
    def test_init_zero_samples_raises_error(self):
    ...
    def test_init_negative_samples_raises_error(self):
...
class TestNumpyTensorSetFromTensorList:
    ...
    def test_from_tensor_list_1d(self):
    ...
    def test_from_tensor_list_2d(self):
    ...
    def test_from_tensor_list_single_tensor(self):
    ...
    def test_from_tensor_list_empty_raises_error(self):
        """Test that empty list raises error."""
        with pytest.raises(ValueError, match="empty tensor list"):
            NumpyTensorSet.from_tensor_list([])

    def test_from_tensor_list_different_grids_raises_error(self):
...
class TestNumpyTensorSetGettersSetters:
    ...
    def test_set_values_wrong_shape_raises_error(self):
    ...
    def test_get_sample_out_of_range_raises_error(self):
...
class TestNumpyTensorSetEvaluation1D:
    ...
    def test_evaluate_1d_with_array(self):
    ...
    def test_evaluate_1d_with_dict(self):
        """Test evaluation with dict input."""
        grid = Grid1D(min_value=0.0, max_value=10.0, n_points=11)
        values = np.array([
            np.linspace(0, 10, 11),
    ...
    def test_evaluate_1d_interpolation(self):
    ...
    def test_evaluate_1d_multiple_keys_raises_error(self):
...
class TestNumpyTensorSetEvaluationProductGrid:
    ...
    def test_evaluate_product_grid_2d(self):
    ...
    def test_evaluate_product_grid_interpolation(self):
    ...
    def test_evaluate_product_grid_missing_dimension_raises_error(self):
    ...
    def test_evaluate_product_grid_vectorized(self):
...
class TestNumpyTensorSetGridsEqual:
    ...
    def test_grids_equal_1d_same(self):
    ...
    def test_grids_equal_1d_different_points(self):
    ...
    def test_grids_equal_1d_different_bounds(self):
    ...
    def test_grids_equal_product_same(self):
    ...
    def test_grids_equal_product_different_dimensions(self):
    ...
    def test_grids_equal_different_types(self):
...
class TestNumpyTensorSetEdgeCases:
    ...
    def test_single_sample_tensor_set(self):
    ...
    def test_evaluate_all_samples_consistent(self):
    ...
    def test_from_tensor_list_preserves_values(self):
        ...
        for i, tensor in enumerate(tensors):
            np.testing.assert_array_equal(
                tensor_set.get_sample(i),
                tensor.values
            )

    def test_from_tensor_list_with_tf_tensors(self):
...
class TestNumpyTensorSetIntegration:
    ...
    def test_round_trip_conversion(self):
        ...
        reconstructed_tensors = [
            NumpyTensor(grid=grid, values=tensor_set.get_sample(i))
            for i in range(tensor_set.n_samples)
        ]
    ...
    def test_evaluation_matches_individual_tensors(self):
    ...
    def test_with_product_grid_complex(self):
...
class TestNumpyTensorSetPerformance:
    ...
    def test_evaluate_large_dataset(self):
...
class TestNumpyTensorSetDocstringExamples:
    ...
    def test_docstring_example_evaluate(self):
    ...
    def test_docstring_example_get_sample(self):
